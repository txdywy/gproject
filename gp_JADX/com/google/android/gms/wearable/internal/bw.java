...
public class bw {
    ...
    private static boolean m26785a(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return m26786a(packageInfo, f28606c, f28607d);
        }
        return m26786a(packageInfo, f28606c);
    }

    private static boolean m26786a(PackageInfo packageInfo, byte[]... bArr) {
    ...
    private static byte[] m26787b(String str) {
        try {
    ...
    private final PackageInfo m26788c(String str) {
        try {
            return dr.f26667b.m24299a(this.f28608b).m24298b(str, 64);
        } catch (NameNotFoundException e) {
            return null;
        }
    }

    public final boolean m26789a(String str) {
        PackageInfo c = m26788c(str);
        if (c == null) {
            return false;
        }
        if (C5105f.m23696f(this.f28608b)) {
            return m26785a(c, true);
        }
        boolean a = m26785a(c, false);
        if (a || !m26785a(c, true)) {
            return a;
        }
