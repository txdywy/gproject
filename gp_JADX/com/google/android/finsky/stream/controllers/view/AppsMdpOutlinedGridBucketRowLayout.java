...
public class AppsMdpOutlinedGridBucketRowLayout extends C4298h {
    public AppsMdpOutlinedGridBucketRowLayout(Context context) {
        this(context, null);
    }

    public AppsMdpOutlinedGridBucketRowLayout(Context context, AttributeSet attributeSet) {
