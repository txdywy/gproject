...
public final class C4493t extends C4302k {
    public final C1461c f22836t;

    public C4493t(Context context, C3748a c3748a, C4808a c4808a, ff ffVar, C3676f c3676f, ad adVar, C1611k c1611k, C1556d c1556d, C2495w c2495w, af afVar, C1461c c1461c, ao aoVar, C4254d c4254d, boolean z, ac acVar) {
    ...
    public final int mo1509a(int i) {
        return C7582R.layout.flat_card_double_wide_ad_cluster;
    }

    public final int mo4099b() {
        return C7582R.layout.flat_card_double_wide_ad;
    }

    protected final C1164b mo4105c() {
        return new C4499u(this);
    }
}
