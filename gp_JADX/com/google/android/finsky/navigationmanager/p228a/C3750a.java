...
public final class C3750a extends C3749d {
    C3750a(C1036b c1036b, C0988c c0988c, C1542f c1542f, C2471a c2471a, C1249a c1249a, C1287h c1287h, C2171b c2171b, C2162a c2162a, C1461c c1461c, C1463g c1463g, C2104b c2104b, C1867w c1867w, ab abVar) {
    ...
    public final void mo3676a(String str, String str2, String str3, String str4, C2495w c2495w) {
        mo3666a(str, null, str2, str3, str4, true, c2495w);
    }

    public final void mo3666a(String str, ax axVar, String str2, String str3, String str4, boolean z, C2495w c2495w) {
        this.b.startActivity(C1473m.f7980a.bo().mo2751a(this.b, str, str2, str3, str4, false, c2495w));
        if (z) {
            this.b.finish();
        }
    }
    ...
    public final void mo3673a(String str, String str2, int i, int i2, DfeToc dfeToc, com.google.android.finsky.p111d.ad adVar, C2495w c2495w) {
        this.b.startActivity(C1473m.f7980a.bo().mo2747a(this.b, str, str2, i, c2495w));
        this.b.finish();
    }
    ...
    public final void mo3646a(DfeToc dfeToc, C2495w c2495w) {
        this.b.startActivity(C1473m.f7980a.bo().mo2738a(this.b, c2495w));
        this.b.finish();
    }
}
