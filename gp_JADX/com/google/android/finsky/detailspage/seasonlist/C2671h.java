...
final class C2671h extends ArrayAdapter {
    public final /* synthetic */ SeasonListModuleLayout f14752a;

    public C2671h(SeasonListModuleLayout seasonListModuleLayout, Context context, List list) {
        this.f14752a = seasonListModuleLayout;
    ...
    public final View getDropDownView(int i, View view, ViewGroup viewGroup) {
        ...
        if (document == this.f14752a.f14728j) {
