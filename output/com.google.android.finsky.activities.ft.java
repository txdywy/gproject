...
protected final class com.google.android.finsky.activities.ft extends AsyncTask
{
    ...
    ft(Context p0, android.support.v7.widget.ff p1) {
        AsyncTask();
        this.a = p1;
        this.b = p0;
    }
    ...
    private final Void a(Integer[] p0) {
        ...
        while (v0 < p0.length) {
            ...
            while (v0 < v5 && this.a.a(v3) < v5 && !this.isCancelled()) {
                try {
                    v6 = new com.google.android.finsky.activities.fu(com.google.android.finsky.bg.d.a(this.b)).b(this.c, v3);
                    if (v6.a != 0)
                        this.a.a(v6);
                }
    ...
    protected final void onPreExecute() {
        super.onPreExecute();
        this.c = new PlayRecyclerView(this.b);
